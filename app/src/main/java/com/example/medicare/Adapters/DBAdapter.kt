...
class DBAdapter {
    ...
    private val dbName = "dbArticle"
    private val dbTable = "Article"
    ...
    private val CREATE_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " +
        dbTable + " (" + colId + " " + "INTEGER PRIMARY KEY," + colTitle + " TEXT, " +colImage+" BLOB, "+
        colCategory+" TEXT, "+colContent+" TEXT, "+colDate+" TEXT, "+
        colAuthor + " TEXT);"
